...
describe('LCOS Glyth radial morph engine', () => {
  ...
  it('draws one closed organic body with two vertical eyes inside it (golden frame, t=0)', () => {
    ...
    expect(width / height).toBeLessThan(1.45)
  ...
  it('keeps four open shell segments around every state', () => {
  ...
  it('stretches the output body along its front direction', () => {
