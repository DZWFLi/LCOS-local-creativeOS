...
export function NodeContextToolbar({ zoom, onRelation, onDuplicate }: Props) {
  ...
  return <div className="node-context-toolbar" style={{ '--node-toolbar-scale': String(1 / zoom), zIndex: 'var(--lcos-z-overlay-ui-high)' } as CSSProperties} onPointerDown={(event) => event.stopPropagation()}>
