import { FilePlus2, FolderInput, Link2, PackageOpen, Search, Upload, Wrench, X } from 'lucide-react'
...
export function CapabilityPopover(props: Props) {
  ...
  const recentAssets = useMemo(() => props.nodes
    .filter((node) => !node.disabled && !node.runtimeTransient)
