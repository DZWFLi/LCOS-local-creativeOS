...
export function WorkspaceDock({ workspaces, activeId, collapsed, onCollapsedChange, capabilitiesOpen, onOpenCapabilities, onOverview, onChange, onLocate, onAddWorkspace, onEditWorkspace, onDuplicateWorkspace, onDeleteWorkspace, onMoveWorkspace, runStatus }: Props) {
