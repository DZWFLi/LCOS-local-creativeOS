import { Archive, Clipboard, Download, FileText, LoaderCircle, X } from 'lucide-react'
...
export function HandoffDialog({ open, loading, manifest, error, onClose, onCopy, onDownload, onDownloadZip }: Props) {
  if (!open) return null
          ...
          : manifest
            ? <>
                ...
                <footer>
                  ...
                  <button className="primary" onClick={onDownloadZip}><Archive size={14} />下载 ZIP</button>
                </footer>
              </>
