...
export function ProjectionSurface(props:Props){
  ...
  return <Suspense fallback={<SurfaceLoading/>}>{props.surface==='outline'?<OutlineSurface {...common}/>:props.surface==='context-flow'?<ContextFlowSurface {...common} runtime={props.contextRuntime}/>:props.surface==='context-tree'?<ContextTreeSurface {...common} runtime={props.contextRuntime}/>:props.surface==='context-graph'?<ContextGraphSurface {...common} runtime={props.contextRuntime}/>:props.surface==='work'?<WorkSurface {...common} runtime={props.workRuntime}/>:props.surface==='work-free'?<WorkFreeSurface {...common}/>:props.surface==='deliver-versions'?<DeliverSurface {...common} runtime={props.deliverRuntime} variant="versions"/>:props.surface==='deliver-pack'?<DeliverSurface {...common} runtime={props.deliverRuntime} variant="pack"/>:<DeliverSurface {...common} runtime={props.deliverRuntime}/>}</Suspense>
}
