...
import type { SkillRunStats, SkillStepInput, WorkflowSkillSummary } from '../workflow/skillLibrary'
...
export function ProjectionSurface(props:Props){
  ...
  const focusable={...common,focusRequest:props.focusRequest,onFocusObject:props.onFocusObject}
  ...
  return <Suspense fallback={<SurfaceLoading/>}>{
    ...
    props.surface==='context-space'?<ContextSpaceSurface {...focusable} onSurfaceChange={props.onSurfaceChange} onDirectProjectViewDrop={props.onDirectProjectViewDrop} onCreateDomainRelation={props.onCreateDomainRelation} onExternalTextDrop={props.onExternalTextDrop} source={{kind:context.sourceKind,label:context.sourceLabel}} runtime={contextRuntime} onImportProjectView={props.onImportProjectViewToContext}/>:
