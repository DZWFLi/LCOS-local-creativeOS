...
export function updateWorkspaceRecord(workspaces: Workspace[], id: string, patch: Partial<Pick<Workspace, 'label' | 'intent' | 'scopeId' | 'camera' | 'visibleLayers' | 'focusedViewIds' | 'contextPolicy' | 'preferredSurface'>>, now: string): Workspace[] {
