...
export function App() {
  ...
  const projectWorkspaceFrames = useMemo(() => workspaces.flatMap((workspace) => buildWorkspaceFrames([workspace], nodes.filter((node) => (node.scopeId ?? 'scope-root') === workspace.scopeId), workspaceId, workspace.scopeId)), [nodes, workspaceId, workspaces])
