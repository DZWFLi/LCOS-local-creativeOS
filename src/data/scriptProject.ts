...
export const scriptProject: ScriptProject = {
  ...
  versions: [
    ...
    { id: 'script-v2', projectId, versionLabel: 'Script V2', title: '热感动作修改稿', summary: '客户反馈后改为扇风、扯长袍。', sourceVersionId: 'script-v1', changeReason: '冰块缺乏来源，改用人物自身热感动作。', feedbackIds: ['review-v2-installation'], decisionId: 'decision-v2', segments: v2Segments, status: 'client_review', createdAt: '2026-07-12T10:00:00+08:00' },
...
export const initialAiDrafts: AiReviewDraft[] = [
  { versionId: 'script-v2', segmentId: 'product-setup', findings: [{ skill: 'Product Communication', finding: '安装动作数量超过“三步”信息承载范围，卖点可能被执行细节稀释。' }, { skill: 'Platform Fit', finding: '连续动作缺少短视频所需的单镜头单信息节奏。' }], originalText: '安装段信息密度过高，建议减少动作数量。', humanRevision: '', disposition: 'pending', confidence: 'high', updatedAt: null },
