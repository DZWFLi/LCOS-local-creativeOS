...
check('Glyph Micro owns LCOS action/state only', signal.includes('LcosGlyphState') && signal.includes("'working'") && signal.includes("'waiting'") && signal.includes("'blocked'") && signal.includes("'candidate'") && !signal.includes('SurfaceIdentityGlyph'))
