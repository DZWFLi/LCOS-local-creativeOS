...
const checks=[
 ...
 ['Selection and Reference stay distinct across execution context and ordered refs', draft.includes('explicitExecutionReferenceIds')&&draft.includes('mergeExecutionContextIds')&&composer.includes('当前选择')&&composer.includes('额外参考')&&app.includes('selectionExecutionReferenceIds')],
