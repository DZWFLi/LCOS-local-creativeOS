...
const required = [
  ['tools/codex-orchestrator/watch.mjs', ['run-codex-task.mjs', 'externalSessionId']],
  ['tools/codex-orchestrator/run-codex-task.mjs', ['--skip-git-repo-check', 'LCOS_CODEX_RESULT:', 'taskkill.exe', 'closureObserved', 'sessionInvalid']],
  ...
  ['apps/web/src/App.tsx', ['answerActiveRunInput', 'activeContextVersionRef.current']],
  ['apps/web/src/features/workrail/WorkRail.tsx', ['继续这个任务', '任务不会因为等待而自动取消', 'run.resultSummary']],
  ['tools/lcos-agent/mcp-server.mjs', ['answer_lcos_run_input', 'select_lcos_views', 'scan_lcos_obsidian_vault', 'import_lcos_obsidian_notes']],
  ['tools/lcos-agent/executor-tools.mjs', ['request_lcos_user_input', 'submit_lcos_result', 'claim_lcos_run']],
  ['packages/skills/lcos-project-context/SKILL.md', ['bind_lcos_project', 'validate_lcos_agent_plan', 'create_lcos_run']],
  ['packages/skills/lcos-project-context/references/structured-error-repair.md', ['ACTIVE_CONTEXT_CONFLICT', '自动修正一次']],
  ['packages/skills/lcos-project-context/references/conversation-import.md', ['零模型调用', 'L1: 规则推导的章节视图']],
  ['packages/skills/lcos-project-context/references/obsidian.md', ['scan_lcos_obsidian_vault', '只读扫描']],
