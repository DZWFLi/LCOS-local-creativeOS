...
const checks = [
  ...
  ['Conversation remains fail-close while A16 permits proven aggregate scope/workspace endpoint identities', endpoints.includes("if (node.entityKind === 'conversation') return null") && endpoints.includes("node.id.startsWith('scope:')") && endpoints.includes("node.id.startsWith('workspace:')") && endpoints.includes('isProjectRelationEligible')],
