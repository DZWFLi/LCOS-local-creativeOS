...
const checks = [
  ...
  ['Reduced Motion has one shared entry', reduced.includes('useReducedSpatialMotion') && visual.includes('@media (prefers-reduced-motion: reduce)')],
  ...
  ['Surface Intent resolves into declarative create-component ops', intent.includes('resolveSurfaceIntent') && intent.includes("type: 'create-component'")],
